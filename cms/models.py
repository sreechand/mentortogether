...
class Notice(models.Model):
    ...
    """
    BOARD_CHOICES = ( ('mentor-homepage', 'Mentor Homepage'),
                      ('mentee-homepage', 'Mentee Homepage') )
    ...
    created_by  = models.ForeignKey(User, editable=False, related_name="notice_creator_set")
    created_on  = models.DateTimeField(auto_now_add=True)
    modified_by = models.ForeignKey(User, editable=False, related_name="notice_modifier_set")
